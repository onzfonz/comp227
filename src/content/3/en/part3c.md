...
The reason for using Mongo as the database is its lower complexity with respect to a relational database. [The optional part 13](https://comp227.djosv.com/part13) of the course shows how to build node.js backends that use a relational database.
